...
$\displaystyle \partial_\mu \frac{\delta L}{\delta(\partial_\mu\phi)}-\frac{\delta L}{\delta \phi}=0\implies (\partial^2_\mu+m^2)\phi=0.$

This is the Klein-Gordan Equation, and it is possible to solve this equation! First we have that

$\displaystyle \partial^2_\mu\phi(t,\textbf{x})=-m^2\phi(t,\textbf{x}).$
...
$\displaystyle \begin{align*}\partial^2_\mu(\exp(ik_\mu x^\mu))&=-k^2_\mu \exp(ik_\mu x^\mu) = -m^2 \exp(ik_\mu x^\mu)\\ &\implies k^2_\mu=m^2.\end{align*}$
...
$\displaystyle Z[\phi]=\int D\phi \exp{\left(\frac{i}{\hbar}\int d^4 x\left(\frac{1}{2}[(\partial \phi)^2-m^2\phi^2]+J\phi\right)\right)}.$

As usual, we let $ \hbar=1$. Now, suppose that the boundary terms of the $ d^4 x$ integral approach 0 at $ \pm \infty$, and let,

$ \displaystyle S(\phi)=\int d^4 x \left(\frac{1}{2}[(\partial\phi)^2-m^2\phi^2]+J\phi\right),$
...
$ \displaystyle \int d^4 x (\partial\phi)^2  = \phi \partial\phi \bigg|^\infty_{-\infty}-\int_{-\infty}^{\infty}d^4 x \phi \left( \partial^2\phi \right).$

Now, we have our ultimate result, keeping in mind that the boundary term disappears,

$ \displaystyle \begin{align*} Z[\phi]&=\int D\phi\exp{\left( i\int d^4 x\left[ \frac{1}{2}((\partial\phi)^2-m^2\phi^2)+J\phi\right] \right)}\\&=\int D\phi\exp{\left( i\int d^4 x\left[- \frac{1}{2}\phi(\partial^2+m^2)\phi+J\phi\right] \right)}.\end{align*}$
...
$ \displaystyle \begin{align*} \int_{-\infty}^\infty\int_{-\infty}^\infty\cdots\int_{-\infty}^\infty dq_1 dq_2 &\cdots dq_N e^{(i/2)q\cdot A \cdot q + i J\cdot q}\\ &=\left(\frac{(2\pi i)^N}{\det[A]}\right)^{1/2}e^{-(i/2)J\cdot A^{-1} \cdot J},\end{align*}$
...
$ \displaystyle \begin{align*}\mathcal{F}[-(\partial^2+m^2)D(x-y)]&=\mathcal{F}[D(x-y)(-\partial^2-m^2)]\\ &=\mathcal{F}[\delta^4(x-y)].\end{align*}$

Then since

$ \displaystyle \begin{align*}\mathcal{F}[D(x-y)(-\partial^2-m^2)]&=\int_{-\infty}^{\infty}D(x-y)[-\partial^2-m^2]e^{-ikx}d^4 x\\ &= \int_{-\infty}^{\infty} d^4 x D(x-y)[k^2-m^2]e^{-ikx}.\end{align*}$

While the right hand side becomes

$ \displaystyle \mathcal{F}[\delta(x-y)]=\int_{-\infty}^{\infty}\delta(x-y)e^{-ikx}d^4 x=e^{-iky}.$
...
$ \displaystyle [k^2-m^2]\int_{-\infty}^{\infty} d^4 x D(x-y)e^{-ikx}=[k^2-m^2]\mathcal{F}[D(x-y)]=e^{-iky}$
...
$ \displaystyle \begin{align*}\mathcal{F}^{-1} [\mathcal{F}[D(x-y)]] &=D(x-y)=\mathcal{F}^{-1}\left[\frac{e^{-iky}}{k^2-m^2} \right] \\ &= \int_{-\infty}^{\infty}\frac{d^4 k}{(2\pi)^4}\frac{e^{-iky}e^{ikx}}{k^2-m^2}.\end{align*}$

$ \displaystyle \therefore \boxed{ D(x-y) = \int_{-\infty}^{\infty}\frac{d^4 k}{(2\pi)^4}\frac{e^{ik(x-y)}}{k^2-m^2}}$
...
$ \displaystyle \boxed{\boxed{ D(x-y) = \int_{-\infty}^{\infty}\frac{d^4 k}{(2\pi)^4}\frac{e^{ik(x-y)}}{k^2-m^2+i\epsilon} .\ }}$
